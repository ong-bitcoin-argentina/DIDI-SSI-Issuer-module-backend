...
const DELEGATE_DURATION = process.env.BLOCK_CHAIN_DELEGATE_DURATION;
const SET_ATTRIBUTE = process.env.BLOCK_CHAIN_SET_ATTRIBUTE;
const RSK_URL = process.env.RSK_URL;
