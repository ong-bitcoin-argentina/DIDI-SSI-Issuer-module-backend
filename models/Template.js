...
TemplateSchema.methods.edit = async function edit(
  data,
  previewData,
  previewType,
  category,
...
Template.generate = async function generate(name, registerId) {
  try {
  ...
  template.previewData = [
    Constants.CERT_FIELD_MANDATORY.FIRST_NAME,
    Constants.CERT_FIELD_MANDATORY.LAST_NAME,
  ];
...
Template.getAll = async function getAll() {
  try {
...
Template.getById = async function getById(id) {
  try {
